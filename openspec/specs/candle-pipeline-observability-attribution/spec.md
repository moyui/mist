# candle-pipeline-observability-attribution Specification

## Purpose
Define candle-pipeline observability attribution: source-labeled skip/discard counters, finalize span verdict attributes, snapshot span key judgment-point attributes with bounded reasons, and retained span events.
## Requirements
