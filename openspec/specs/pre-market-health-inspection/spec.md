...
## Purpose
Govern the automated 09:05 pre-market health inspection workflow across all operational dimensions (datasource/journal, K-lines, active subscriptions, realtime stream connectivity, and infrastructure) on A-share trading days, producing intelligent WeChat diagnostic briefs before market open.
