# declarative-realtime-configuration Specification

## Purpose
Define declarative realtime subscription configuration: database as the only desired authority (allowlist assignments and auto-reconcile switch), timed convergence to declared state, runtime switch semantics and a write path preserving validation and audit.
## Requirements
