# realtime-source-layout Specification

## Purpose
Defines the maintained TDX/QMT realtime source layout, including aligned provider-local responsibilities, explicit provider-specific exceptions, stable bridge identities, and guards that preserve external behavior.
