# otel-observability-assets Specification

## Purpose
Define OTLP credential hygiene: no reversible plaintext defaults in compose/env examples, credentials managed as required .env entries with deploy-script coverage, and no telemetry regression when credentials are explicit.
## Requirements
