# backend-log-access Specification

## Purpose
Define parameterized backend log reading tooling, UTC-based time-window computation for log/verification scripts and documented OpenObserve metrics query behavior without extra snapshot storage.
## Requirements
