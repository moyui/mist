...
## Purpose
Define backend candle-pipeline observability: snapshot aggregation and due finalization tracing with bounded span events, silent data-loss point observability, OTel candle health metrics and low-cardinality labels.
## Requirements
