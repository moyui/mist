...
## Purpose
Define the shared Decimal8 quantity arithmetic primitive: scale-eight bigint value with DECIMAL(36,8) bounds, one-time canonical text normalization, compact canonical string representation, approved V1 operation set, decimal-string serialization boundaries, no numeric compatibility coercion and no third-party decimal dependency.
## Requirements
